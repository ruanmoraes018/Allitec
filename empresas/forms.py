...
class EmpresaForm(forms.ModelForm):
    ...
    principal = forms.ChoiceField(label="Principal?", choices=[('Sim', 'Sim'), ('Não', 'Não')], widget=forms.Select(attrs={'class': 'form-select form-select-sm border-dark-subtle'}))
    dia_venc = forms.ChoiceField(label="Dia Venc.", choices=[('05', '05'), ('10', '10'), ('15', '15'), ('20', '20'), ('25', '25'), ('30', '30')], widget=forms.Select(attrs={'class': 'form-select form-select-sm border-dark-subtle'}))
    cnpj = forms.CharField(label='CNPJ', widget=forms.TextInput(attrs={'class': 'form-control form-control-sm border-dark-subtle'}))
    ie = forms.CharField(label='IE', required=False, widget=forms.TextInput(attrs={'class': 'form-control form-control-sm border-dark-subtle'}))
    ...
    bairro_emp = forms.CharField(label='Bairro', widget=forms.TextInput(attrs={'class': 'form-control form-control-sm border-dark-subtle text-uppercase'}))
    ...
    cidade_emp = forms.CharField(label='Cidade', widget=forms.TextInput(attrs={'class': 'form-control form-control-sm border-dark-subtle text-uppercase'}))
    uf_emp = forms.CharField(label='Estado', widget=forms.TextInput(attrs={'class': 'form-control form-control-sm border-dark-subtle text-uppercase'}))
    ...
    dt_nasc = forms.CharField(label="Data de Nascimento", widget=forms.TextInput(attrs={'class': 'form-control form-control-sm border-dark-subtle text-uppercase'}))
    endereco_adm = forms.CharField(label="Endereço", widget=forms.TextInput(attrs={'class': 'form-control form-control-sm border-dark-subtle text-uppercase'}))
    cep_adm = forms.CharField(label="CEP", widget=forms.TextInput(attrs={'class': 'form-control form-control-sm border-dark-subtle text-uppercase'}))
    numero_adm = forms.CharField(label="Nº", widget=forms.TextInput(attrs={'class': 'form-control form-control-sm border-dark-subtle text-uppercase'}))
    bairro_adm = forms.CharField(label="Bairro", widget=forms.TextInput(attrs={'class': 'form-control form-control-sm border-dark-subtle text-uppercase'}))
    cidade_adm = forms.CharField(label="Cidade", widget=forms.TextInput(attrs={'class': 'form-control form-control-sm border-dark-subtle text-uppercase'}))

...
urlpatterns = [
    ...
    path("att/<int:codigo>/", views.att_entrada, name='att-entrada'),
    path("del/<int:codigo>/", views.del_entrada, name='del-entrada'),
    path("efetivar/<int:codigo>/", views.efetivar_entrada, name='efetivar-entrada'),
    path("cancelar/<int:codigo>/", views.cancelar_entrada, name='cancelar-entrada'),
    path('entradas-produto/<int:produto__codigo>/', views.entradas_por_produto, name='entradas_por_produto'),

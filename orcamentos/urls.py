...
urlpatterns = [
    ...
    path('detalhes_ajax/<int:id>/', views.detalhes_orc_ajax, name='detalhes_orc_ajax'),
    ...
    path("pdf.orcamento/<int:id>/", views.pdf_orcamento_html, name='pdf-orcamento'),
    path("pdf.contrato/<int:id>/", views.pdf_contrato_html, name='pdf-contrato'),
    path("pdf.proposta/<int:id>/", views.pdf_proposta_html, name='pdf-proposta'),
    path('pdf.producao/<int:id>/', views.pdf_producao_html, name='pdf-producao'),
    path('fat.orc/<int:id>/', views.faturar_orcamento, name='faturar-orcamento'),
    path('canc.orc/<int:id>/', views.cancelar_orcamento, name='cancelar-orcamento'),

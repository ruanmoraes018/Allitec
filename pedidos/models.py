...
class PedidoProduto(models.Model):
    ...
    tp_desc_acres = models.CharField(
        max_length=10,
        choices=[('Desconto', 'Desconto'), ('Acréscimo', 'Acréscimo')],
        default='Desconto'
    )
    tipo_desc = models.CharField(
        max_length=10,
        choices=[('valor', 'Valor'), ('percentual', 'Percentual')],
        default='valor'
    )

    desc_acres = models.DecimalField(
        max_digits=10,
        decimal_places=2,
        default=0
    )

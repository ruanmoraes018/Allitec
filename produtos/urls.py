...
urlpatterns = [
    ...
    path("att/<int:codigo>/", views.att_produto, name='att-produto'),
    path("del/<int:codigo>/", views.del_produto, name='del-produto'),
    path("clonar/<int:codigo>/", views.clonar_produto, name='clonar-produto'),
